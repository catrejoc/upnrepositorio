...
values(id_n,'".$_POST['titulo']."',curdate()".",'".$_POST['selec']."','".$_SESSION['id_user']."','".$_POST['conte']."')";
    ...
    <body>
        <div class="contenedor">
            ...
            <div id="buscador" class="texto"> <form id="crd" method="post" action="buscar.php">
                <input name="buscar" id="buscar"><input type="submit" value="buscar">
                </form>
...
apellido paterno<br><input type=text name=pa required /><br>
apellido materno<br><input type=text name=ma required /><br>
correo<br><input type=email name=correo required /><br>
contraseña<br><input type=password name=pass required /><br>
Tipo de usuario: <select name=privi>";

       $s = "select * from privilegios";
       $d = mysql_query($s) or die (mysql_error());
       while ($row=mysql_fetch_array($d)){
       echo "<option value=".$row['id'].">".$row['tipo'];
       echo "</option>";
       }
    
echo "</select>
<br><input type=submit value=registrar name=registrar />
</form>";
            

if (isset ($_POST['registrar'])){

 $consulta = "insert into users (id,nombre,a_pa,a_ma,correo,pass,privilegios) values(id,'".$_POST['nombre']."','".$_POST['pa']."','".$_POST['ma']."','".$_POST['correo']."','".$_POST['pass']."','".$_POST['privi']."')";
